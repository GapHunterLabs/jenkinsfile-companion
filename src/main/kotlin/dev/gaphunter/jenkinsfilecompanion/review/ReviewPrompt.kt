package dev.gaphunter.jenkinsfilecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.jenkinsfilecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.jenkinsfilecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Jenkinsfile Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33390-jenkinsfile-companion/reviews"
